...
type UpdateCardProps = {
  ...
  isOwner?: boolean;                // true if update created by project owner
  updateNumber?: number;
};
...
const UpdateCard = ({
  ...
  return (
    <>
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition p-6 space-y-5 relative">
        {/* Header */}
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-100">
          ...
          {isOwner && onDelete && (
            <div className="absolute bottom-4 right-4">
              <button
                className="text-white bg-red-500 px-3 py-1 rounded hover:bg-red-600 text-sm font-medium"
