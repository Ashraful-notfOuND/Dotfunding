...
{/* Decorative Top Gradient Bar - Now Pinkish */}
<div className="h-32 bg-gradient-to-r from-rose-400 via-pink-400 to-fuchsia-500" />    
    <CardContent className="relative pt-0 pb-8 px-6 md:px-10">
      <div className="flex flex-col md:flex-row gap-8 items-start md:items-end -mt-12">
        ...
        <div className="relative group">
          <div className="w-32 h-32 rounded-2xl overflow-hidden border-4 border-white shadow-2xl transition-transform duration-300 group-hover:scale-105">
            <img
        ...
        <div className="flex-1 space-y-2">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            ...
            <span className="hidden sm:block px-3 py-1 bg-blue-50 text-blue-600 text-xs font-bold rounded-full uppercase tracking-wider">
              Verified Member
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-y-2 gap-x-4 text-sm text-gray-600">
            <span className="flex items-center gap-1.5 font-medium">
              <span className="opacity-70 text-blue-500 font-bold">@</span> {profileData.email}
            </span>
            {user.phone && (
              <span className="flex items-center gap-1.5">
                <span className="grayscale">📱</span> {user.phone}
              </span>
            )}
            {user.location && (
              <span className="flex items-center gap-1.5">
                <span className="grayscale">📍</span> {user.location}
              </span>
            )}
          </div>
        </div>
        ...
        <Link to="/profile/edit" className="w-full md:w-auto">
          <Button 
            variant="outline" 
            className="w-full md:w-auto shadow-sm hover:shadow-md transition-all active:scale-95 bg-white border-gray-200"
          >
      ...
      <div className="mt-10 pt-8 border-t border-gray-100 grid grid-cols-2 md:grid-cols-4 gap-6">
        <div className="space-y-1">
          <p className="text-2xl font-bold text-gray-900">{profileData.projectsCreated}</p>
          <p className="text-xs uppercase tracking-widest text-muted-foreground font-semibold">Projects Created</p>
        </div>
        
        <div className="space-y-1">
          <p className="text-2xl font-bold text-gray-900">{profileData.projectsBacked}</p>
          <p className="text-xs uppercase tracking-widest text-muted-foreground font-semibold">Projects Backed</p>
        </div>

        <div className="space-y-1">
          <p className="text-2xl font-bold text-blue-600">৳{profileData.totalBacked.toLocaleString()}</p>
          <p className="text-xs uppercase tracking-widest text-muted-foreground font-semibold">Total Invested</p>
        </div>
