-- Complete Pattern System Database Schema
...
ADD COLUMN IF NOT EXISTS priority VARCHAR(20) DEFAULT 'normal', -- Decorator: Priority
ADD COLUMN IF NOT EXISTS channel VARCHAR(20) DEFAULT 'in-app', -- Factory: Channel type
ADD COLUMN IF NOT EXISTS tracking_id VARCHAR(100), -- Decorator: Tracking
ADD COLUMN IF NOT EXISTS personalized BOOLEAN DEFAULT FALSE, -- Decorator: Personalization
ADD COLUMN IF NOT EXISTS sent_at TIMESTAMP,
ADD COLUMN IF NOT EXISTS delivery_status VARCHAR(20) DEFAULT 'pending'; -- sent, failed, delivered
...
ADD COLUMN IF NOT EXISTS pledge_count INTEGER DEFAULT 0,
ADD COLUMN IF NOT EXISTS last_pledge_at TIMESTAMP,
